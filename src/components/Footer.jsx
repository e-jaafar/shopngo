...
const Footer = () => {
  const socialLinks = {
    facebook: "https://facebook.com/shopngo",
    instagram: "https://instagram.com/shopngo",
    twitter: "https://twitter.com/shopngo"
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/press" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Presse
                </Link>
              </li>
            </ul>
          ...
          {/* Service client */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Service Client</h3>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Informations Légales</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link to="/cookies" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Cookies
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <form className="space-y-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="w-full px-4 py-2 rounded-md bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400"
              />
              <button
                type="submit"
                className="w-full px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors"
              >
                S'inscrire
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              © {new Date().getFullYear()} ShopnGo. Tous droits réservés.
            </p>
          </div>
        </div>
      </div>
